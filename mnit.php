...
<div class="col-sm-12">
			...
			<h4 class=" tc-black mg-sm">
					...
					<a class="ltc-black" href="mnit.php">Internship &amp; Placement Cell</a>
				</h4>
				<h6 class=" mg-clear tc-1">
					 <a class="pull-left" href="http://www.mnit.ac.in" target="_blank"> K K Wagh Institute of Engineering Education & Research, Nashik</a><br>
				</h6>
			</div>
		</div>
	</div>
...
<div class="mySlides fade">
  ...
  <img src="./Images/kkw2.jpeg" style="width:100%" height="425">
  <div class="text">K K Wagh Institute of Engineering Education & Research, Nashik</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="./Images/kkw4.jpg" style="width:100%" height="425">
  <div class="text">K K Wagh Institute of Engineering Education & Research, Nashik</div>
</div>
